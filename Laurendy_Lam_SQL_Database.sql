...
--
-- Host: 127.0.0.1
-- Generation Time: May 1, 2022 at 03:59 PM
...
-- Database: `rentalmtl`
--
CREATE DATABASE IF NOT EXISTS `nkalaga1` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `nkalaga1`;
...
INSERT INTO `county` (`BoroughID`, `bname`, `longitude`, `latitude`) VALUES
...
--
-- Table structure for table `sellersearch`
--

DROP TABLE IF EXISTS `sellersearch`;
...
--
-- Dumping data for table `sellersearch`
--

INSERT INTO `sellersearch` (`MemberID`, `agemin`, `agemax`, `occupation`, `income`, `pet`, `smoke`) VALUES
(6, 18, 18, 0, -1, 'any', 'no');
...
INSERT INTO `property` (`MemberID`, `PostID`, `title`, `price`, `borough`, `address`, `image`, `description`) VALUES
...
INSERT INTO `buyerinfo` (`MemberID`, `age`, `occupation`, `income`, `pet`, `smoker`) VALUES
(2, 34, 0, 1, 'yes', 'no'),
(3, 18, 0, 6, 'yes', 'no'),
(4, 23, 6, 0, 'no', 'yes'),
(5, 25, 5, 0, 'no', 'no'),
...
--
-- Table structure for table `buyersearch`
--

DROP TABLE IF EXISTS `buyersearch`;
...
--
-- Dumping data for table `buyersearch`
--

INSERT INTO `buyersearch` (`MemberID`, `borough`, `price`) VALUES
(1, 14, 999),
(2, -1, 999),
(12, 17, 600);
